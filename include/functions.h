...
void func_800F9824(GlobalContext* globalCtx, KankyoContext* kanCtxt, View* view, GraphicsContext* gfxCtx, Vec3f vec, f32 argA, f32 argB, s8 argC, s8 argD);
